...
let trainerSchema = new Schema({
    ...
    role: { type: String, required: [true, 'El rol es requerido'], default: 'TRAINER_ROLE', enum: { values: ['ADMIN_ROLE', 'USER_ROLE', 'GYM_ROLE','TRAINER_ROLE'] , message: '{VALUE} No es un rol valido' } },
